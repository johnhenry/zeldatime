    ...
    <SlateFrame>
      <div className="codex-index">
        ...
        <div className="codex-index__grid">
          ...
          <Link to="/codex/unplaced" className="codex-index__card panel">
          ...
          <Link to="/codex/species" className="codex-index__card panel">
          ...
          <Link to="/codex/aoi-maps" className="codex-index__card panel">
